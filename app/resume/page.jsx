...
const about = {
  ...
  info: [
    {
      fieldName: "Name",
      fieldValue: "Adefemi Adekunle"
    },
    {
      fieldName: "Phone",
      fieldValue: "+2348133044413"
    },
    {
    ...
    {
      fieldName: "Email",
      fieldValue: "Adefemilouis@gmail.com"
       },
  ...
  >
    ...
    <TabsContent value="experience" className="w-full">
     ...
     <div className="flex flex-col gap-[30px] text-center xl:text-left">
      ...
      <p className="max-w-[638px] text-white/60 mx-auto xl-mx-0">
    ...
    <TabsContent value="skills" className="w-full">
      <div className="flex flex-col gap-[30px] ">
        <div className="flex flex-col gap-[30px] text-center xl:text-left">
          ...
          <p className="max-w-[600px] text-white/60 m-auto xl-mx-0 ">{skills.description}</p>
        </div>
