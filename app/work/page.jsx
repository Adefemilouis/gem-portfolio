...
const projects = [
  {
    ...
    image: "/assets/images/wor.png", // Corrected path
    live: "",
    github: "",
  },
  {
    ...
    image: '/assets/images/wat.png' , // Corrected path
    live: "",
    github: "",
  },
];
          ...
          <div className="w-full xl:w-[50%]">
            ...
            >
              ...
              <WorkSliderBtns
                ...
                btnStyles="bg-accent-hover text-primary text-[22px] w-[44px] h-[44px] flex justify-center items-center transition-all"
              />
            </Swiper>
          </div>
        </div>
